...
float convertRawToVoltage(){
    int16_t rawValue = ADS1115_get_conversion();
    // // ESP_LOGE("convertRawToVoltage","RAW VALUE: %d",rawValue);
    float convertedVoltage = ((float)((rawValue)*4.096)/32768);
    // ESP_LOGE("convertRawToVoltage","Voltage: %f",convertedVoltage);
